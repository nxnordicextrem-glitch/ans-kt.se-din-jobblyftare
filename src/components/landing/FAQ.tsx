...
const faqs = [
  { q: "Är Ansökt verkligen gratis att börja med?", a: "Ja. Du kan registrera dig och börja bygga ditt CV utan att betala. Premium krävs först när du vill exportera till PDF eller använda AI-brevet." },
  ...
  { q: "Kan jag använda Ansökt på engelska?", a: "Ja, alla CV och brev kan genereras både på svenska och engelska." },
];
